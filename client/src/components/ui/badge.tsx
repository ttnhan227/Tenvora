  ...
  "inline-flex items-center gap-1 rounded px-2 py-0.5 text-[10px] font-semibold tracking-tight transition-colors border tabular-nums",
  {
    variants: {
      variant: {
        ...
        success: "border-green-600/20 bg-green-500/10 text-green-700 dark:text-green-400 font-medium",
        ...
        low: "border-green-600/25 bg-green-500/10 text-green-700 dark:text-green-400 font-medium",
      },
    },
    defaultVariants: {
      variant: "default",
